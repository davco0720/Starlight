...
public class M2N1 extends JFrame implements ActionListener, KeyListener {
...
//JORDAN
    ...
    private int bloquehitx = 290;
    private int bloquehitx2 = 290;
    private int bloquehitx3 = 500;
    private int bloquehitx4 = 290;

    int fadeOpacity = 0;
    boolean fading = false;

    private int bloquehitx2_0 = 740;
    private int bloquehitx2_1 = 740;
    private int bloquehitx2_2 = 945;//ya esta
    private int bloquehitx2_3 = 740;

    private int bloquehitx3_0 = 1160;
    private int bloquehitx3_1 = 1160;
    private int bloquehitx3_2 = 1225;//ya esta
    private int bloquehitx3_3 = 1160;

    private int bloquehitx4_0 = 1735; //ya esta
    private int bloquehitx4_1 = 1735;
    private int bloquehitx4_2 = 1945;
    private int bloquehitx4_3 = 1735;

    private int bloquehitx5_0 = 1898;
    private int bloquehitx5_1 = 1898; //ya esta
    private int bloquehitx5_2 = 1955;
    private int bloquehitx5_3 = 1898;

    private int bloquehitx6_0 = 1995;
    private int bloquehitx6_1 = 1995;
    private int bloquehitx6_2 = 2215; //ya esta
    private int bloquehitx6_3 = 1995;

    private int bloquehitx7_0 = 1340;
    private int bloquehitx7_1 = 1340; //ya esta
    private int bloquehitx7_2 = 1530;
    private int bloquehitx7_3 = 1340;

    private int bloquehitx8_0 = 2885;
    private int bloquehitx8_1 = 2885;
    private int bloquehitx8_2 = 3950;
    private int bloquehitx8_3 = 2885;

    private int bloquehitx9_0 = 1595; //ya esta
    private int bloquehitx9_1 = 1595;
    private int bloquehitx9_2 = 1650;
    private int bloquehitx9_3 = 1595;

    private int bloquehitx10_0 = 1825;
    private int bloquehitx10_1 = 1825; //ya esta 
    private int bloquehitx10_2 = 1955;
    private int bloquehitx10_3 = 1825;

    private int bloquehitx11_0 = 2255;
    private int bloquehitx11_1 = 2255; //ya esta
    private int bloquehitx11_2 = 2690;
    private int bloquehitx11_3 = 2255;

    private int bloquehitx12_0 = 2640;
    private int bloquehitx12_1 = 2640;
    private int bloquehitx12_2 = 2700; //ya esta
    private int bloquehitx12_3 = 2640;

    private int bloquehitx13_0 = 2285;
    private int bloquehitx13_1 = 2285; //Ya esta
    private int bloquehitx13_2 = 2505;
    private int bloquehitx13_3 = 2285;

    private int bloquehitx14_0 = 2235;
    private int bloquehitx14_1 = 2235;//ya esta
    private int bloquehitx14_2 = 2293;
    private int bloquehitx14_3 = 2235;

    private int bloquehitx15_0 = 2400;
    private int bloquehitx15_1 = 2400; //ya esta
    private int bloquehitx15_2 = 2835;
    private int bloquehitx15_3 = 2400;

    private double vidas = 3;
    private int obstaculox = 525;
    private int obstaculox2 = 735;
    private int obstaculox4 = 275; //Pincho_largo_1
    ...
    public M2N1() {
        ...
        try {
            fondoImage = ImageIO.read(new File("src/Fondo/Mundo21.png")); // ruta del fondo
        ...
        try {
            degradado = ImageIO.read(new File("src/Recursos/Degradado.png")); // ruta del degradado
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        slime2 = new BufferedImage[6];
        for (int i = 0; i < slime2.length; i++) {
            try {
                slime2[i] = ImageIO.read(new File("src/Fantasma/" + (i + 1) + ".png"));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }

        Zombie2 = new BufferedImage[6];
        for (int i = 0; i < Zombie2.length; i++) {
            try {
                Zombie2[i] = ImageIO.read(new File("src/Fantasma/" + (i + 1) + ".png"));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        }
...
//        reproductor.iniciar();
        ...
        bloquehit = new Hitbox(bloquehitx, 620, 210, 1);
        bloquehit1 = new Hitbox(bloquehitx2, 620, 1, 50);
        bloquehit2 = new Hitbox(bloquehitx3, 620, 1, 50);
        bloquehit3 = new Hitbox(bloquehitx4, 670, 210, 1);

        bloquehit2_0 = new Hitbox(bloquehitx2_0, 620, 205, 1);
        bloquehit2_1 = new Hitbox(bloquehitx2_1, 620, 1, 50);
        bloquehit2_2 = new Hitbox(bloquehitx2_2, 620, 1, 50);
        bloquehit2_3 = new Hitbox(bloquehitx2_3, 670, 205, 1);

        bloquehit3_0 = new Hitbox(bloquehitx3_0, 560, 65, 1);
        bloquehit3_1 = new Hitbox(bloquehitx3_1, 560, 1, 50);
        bloquehit3_2 = new Hitbox(bloquehitx3_2, 560, 1, 50);
        bloquehit3_3 = new Hitbox(bloquehitx3_3, 610, 65, 1);

        bloquehit4_0 = new Hitbox(bloquehitx4_0, 340, 210, 1);
        bloquehit4_1 = new Hitbox(bloquehitx4_1, 340, 1, 50);
        bloquehit4_2 = new Hitbox(bloquehitx4_2, 340, 1, 50);
        bloquehit4_3 = new Hitbox(bloquehitx4_3, 390, 210, 1);

        bloquehit5_0 = new Hitbox(bloquehitx5_0, 243, 55, 1);
        bloquehit5_1 = new Hitbox(bloquehitx5_1, 243, 1, 50);
        bloquehit5_2 = new Hitbox(bloquehitx5_2, 243, 1, 50);
        bloquehit5_3 = new Hitbox(bloquehitx5_3, 293, 55, 1);

        bloquehit6_0 = new Hitbox(bloquehitx6_0, 587, 220, 1);
        bloquehit6_1 = new Hitbox(bloquehitx6_1, 587, 1, 50);
        bloquehit6_2 = new Hitbox(bloquehitx6_2, 587, 1, 50);
        bloquehit6_3 = new Hitbox(bloquehitx6_3, 637, 220, 1);

        bloquehit7_0 = new Hitbox(bloquehitx7_0, 490, 190, 1);
        bloquehit7_1 = new Hitbox(bloquehitx7_1, 490, 1, 180);
        bloquehit7_2 = new Hitbox(bloquehitx7_2, 490, 1, 180);
        bloquehit7_3 = new Hitbox(bloquehitx7_3, 670, 190, 1);

        bloquehit8_0 = new Hitbox(bloquehitx8_0, 305, 150, 1);
        bloquehit8_1 = new Hitbox(bloquehitx8_1, 305, 1, 2898);
        bloquehit8_2 = new Hitbox(bloquehitx8_2, 305, 1, 2898);
        bloquehit8_3 = new Hitbox(bloquehitx8_3, 766, 150, 1);

        bloquehit9_0 = new Hitbox(bloquehitx9_0, 410, 55, 1);
        bloquehit9_1 = new Hitbox(bloquehitx9_1, 410, 1, 29);
        bloquehit9_2 = new Hitbox(bloquehitx9_2, 410, 1, 29);
        bloquehit9_3 = new Hitbox(bloquehitx9_3, 439, 55, 1);

        bloquehit10_0 = new Hitbox(bloquehitx10_0, 405, 130, 1);
        bloquehit10_1 = new Hitbox(bloquehitx10_1, 405, 1, 365);
        bloquehit10_2 = new Hitbox(bloquehitx10_2, 405, 1, 365);
        bloquehit10_3 = new Hitbox(bloquehitx10_3, 765, 130, 1);

        bloquehit11_0 = new Hitbox(bloquehitx11_0, 500, 435, 1);
        bloquehit11_1 = new Hitbox(bloquehitx11_1, 500, 1, 50);
        bloquehit11_2 = new Hitbox(bloquehitx11_2, 500, 1, 50);
        bloquehit11_3 = new Hitbox(bloquehitx11_3, 550, 435, 1);

        bloquehit12_0 = new Hitbox(bloquehitx12_0, 420, 55, 1);
        bloquehit12_1 = new Hitbox(bloquehitx12_1, 420, 1, 50);
        bloquehit12_2 = new Hitbox(bloquehitx12_2, 420, 1, 50);
        bloquehit12_3 = new Hitbox(bloquehitx12_3, 470, 55, 1);

        bloquehit13_0 = new Hitbox(bloquehitx13_0, 347, 220, 1);
        bloquehit13_1 = new Hitbox(bloquehitx13_1, 347, 1, 50);
        bloquehit13_2 = new Hitbox(bloquehitx13_2, 347, 1, 50);
        bloquehit13_3 = new Hitbox(bloquehitx13_3, 395, 220, 1);

        bloquehit14_0 = new Hitbox(bloquehitx14_0, 262, 60, 1);
        bloquehit14_1 = new Hitbox(bloquehitx14_1, 262, 1, 50);
        bloquehit14_2 = new Hitbox(bloquehitx14_2, 262, 1, 50);
        bloquehit14_3 = new Hitbox(bloquehitx14_3, 312, 60, 1);

        bloquehit15_0 = new Hitbox(bloquehitx15_0, 185, 435, 1);
        bloquehit15_1 = new Hitbox(bloquehitx15_1, 185, 1, 50);
        bloquehit15_2 = new Hitbox(bloquehitx15_2, 185, 1, 50);
        bloquehit15_3 = new Hitbox(bloquehitx15_3, 235, 435, 1);

        obstaculohit = new Hitbox(2245, 436, 175, 1);
        obstaculohit1 = new Hitbox(430, 430, 180, 1);
        obstaculohit3 = new Hitbox(435, 435, 190, 1);
    ...
    private void insertar() {
        try {
            ...
            String Query = "SELECT Puntaje FROM M2N1 WHERE BINARY ID_User=?";
            try (PreparedStatement statement = conexion.ConexionBD().prepareStatement(Query)) {
                ...
                try (ResultSet recordAnterior = statement.executeQuery()) {
                    ...
                    if (recordAnterior.next()) {
                        ...
                        if (ScoreNuevo > ScoreAnterior) {
                            String QueryInsertar = "UPDATE M2N1 SET Puntaje=?, Fecha=?, Tiempo_Restante=? WHERE ID_User=?";
                        ...
                        String QueryInsertar = "INSERT INTO M2N1 (ID_User, Puntaje, Fecha, Tiempo_Restante) VALUES (?,?, ?, ?)";
                        Connection con = conexion.ConexionBD();
                        //statement sirve para preparar la query para interactuar con la base de datos
                        PreparedStatement statementInsertar = con.prepareStatement(QueryInsertar);
                        //Los setstring sirven para poder manipular consultas parametrizadas
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (!pausa) {
            ...
            slimexRelativo = Math.min(Math.max(slimexRelativo, 1370), 1500);
            if (jumping || falling) {
                frameIndex4++;
            ...
            //Zombie 2        
            Zombie = Math.min(Math.max(Zombie, 2020), 2180);
            if (jumping || falling) {
                frameIndex4++;
                if (frameIndex4 >= Jumpanimation.length) {
                    frameIndex4 = 0;
    ...
    private void drawGem(Graphics g) {
        if (frameIndex2 >= 0 && frameIndex2 < gem.length) {
            ...
            g.drawImage(gem[frameIndex2], gemx, 220, 38, 79, null);

            gemhit[frameIndex2].setX(gemx);
            gemhit[frameIndex2].setY(220);
    ...
    private void drawCoin(Graphics g) {
        if (frameindex10 >= 0 && frameindex10 < coin.length && coin[frameindex10] != null) {
            ...
            if (personajeHitbox.intersects(coinet[frameindex10])) {
                ...
                g.drawImage(coin[frameindex10], coinx, 510, 40, 65, null);
            }
    ...
    private void drawCoin3(Graphics g) {
        if (frameindex12 >= 0 && frameindex12 < coin3.length && coin3[frameindex12] != null) {
            ...
            if (personajeHitbox.intersects(coinet3[frameindex12])) {
                ...
                // Solo se muestra la moneda si el persoanje no a pasado sobre ella
                g.drawImage(coin3[frameindex12], coinx3, 400, 40, 65, null);
    ...
    private void drawCoin4(Graphics g) {
        if (frameindex13 >= 0 && frameindex13 < coin4.length && coin4[frameindex13] != null) {
            ...
            if (personajeHitbox.intersects(coinet4[frameindex13])) {
                ...
                // Solo se muestra la moneda si el persoanje no a pasado sobre ella
                g.drawImage(coin4[frameindex13], coinx4, 450, 40, 65, null);
    ...
    private void drawExtra(Graphics g) {
        if (frameindex14 >= 0 && frameindex14 < Extra.length && Extra[frameindex14] != null) {
            ...
            Extranet[frameindex14].setY(415);
            ...
            if (personajeHitbox.intersects(Extranet[frameindex14])) {
                ...
                // Solo se muestra la moneda si el persoanje no a pasado sobre ella
                g.drawImage(Extra[frameindex14], Extrax, 415, 68, 80, null);
    ...
    private void drawSlime(Graphics g) {
        if (frameIndex3 >= 0 && frameIndex3 < slime2.length) {
            ...
            g.drawImage(slime2[frameIndex3], slimex, 390, 77, 77, null);

            slime2hit[frameIndex3].setX(slimex);
            slime2hit[frameIndex3].setY(390);
