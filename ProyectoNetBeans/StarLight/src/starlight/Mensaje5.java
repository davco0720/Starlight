...
public class Mensaje5 extends javax.swing.JDialog {
        Redimensionar redimensiones = new Redimensionar();
    public Mensaje5(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        try{
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/NoCoinciden.png");
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje5 dialog = new Mensaje5(new javax.swing.JFrame(), true);
