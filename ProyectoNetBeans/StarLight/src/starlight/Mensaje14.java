...
public class Mensaje14 extends javax.swing.JDialog {
        Redimensionar redimensiones = new Redimensionar();
    public Mensaje14(java.awt.Frame parent, boolean modal) {
        ...
        try{
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/FinTiempo.png");
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje14.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje14 dialog = new Mensaje14(new javax.swing.JFrame(), true);
