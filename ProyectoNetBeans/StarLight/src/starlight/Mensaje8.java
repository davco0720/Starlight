...
public class Mensaje8 extends javax.swing.JDialog {
        Redimensionar redimensiones = new Redimensionar();
    public Mensaje8(java.awt.Frame parent, boolean modal) {
        ...
        try{
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/Inesperado.png");
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje8 dialog = new Mensaje8(new javax.swing.JFrame(), true);
