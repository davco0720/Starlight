...
public class Mensaje15 extends javax.swing.JDialog {
        Redimensionar redimensiones = new Redimensionar();
    public Mensaje15(java.awt.Frame parent, boolean modal) {
        ...
        try{
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/NivelTerminado.png");
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje15.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje15 dialog = new Mensaje15(new javax.swing.JFrame(), true);
