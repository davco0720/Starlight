...
public class PR_32 extends JFrame implements ActionListener, KeyListener {
//NUEVO CESAR
    //CESAR
...
private int frameIndex222=0;
    ...
    public PR_32() {
        ...
        AttackHit = new Hitbox3[Attack.length];
        for (int i = 0; i < AttackHit.length; i++) {
            AttackHit[i] = new Hitbox3(personajeX, personajeY, 80, 80);
        }
       ...
       drawAttack_Boss(gBuffer);
        ...
        if (!pausa) {
            ...
            if (jumping) {
                ...
                if (personajeY <= initialY - salto) { // Altura máxima del salto basada en la posición iniciald
                    jumping = false;
                    falling = true;
                }
            ...
            if (personajeHitbox.intersects(obstaculohit) || personajeHitbox.intersects(obstaculohit1) || personajeHitbox.intersects(obstaculohit3) || personajeHitbox.intersects(obstaculohit5) || personajeHitbox.intersects(obstaculohit6) || personajeHitbox.intersects(Runhit[frameindex6]) || personajeHitbox.intersects(Runhit2[frameIndex7])) {
