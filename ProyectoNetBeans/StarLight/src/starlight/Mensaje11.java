...
public class Mensaje11 extends javax.swing.JDialog {
        Redimensionar redimensiones = new Redimensionar();
    public Mensaje11(java.awt.Frame parent, boolean modal) {
        ...
        try{
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/ContraseñaIncorrecta.png");
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje11 dialog = new Mensaje11(new javax.swing.JFrame(), true);
