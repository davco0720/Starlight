...
public class Mensaje17 extends javax.swing.JDialog {
        Redimensionar redimensiones = new Redimensionar();
    public Mensaje17(java.awt.Frame parent, boolean modal) {
        ...
        try{
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/Max254.png");
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje17.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje17 dialog = new Mensaje17(new javax.swing.JFrame(), true);
