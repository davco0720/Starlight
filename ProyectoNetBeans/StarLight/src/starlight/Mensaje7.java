...
public class Mensaje7 extends javax.swing.JDialog {

    Redimensionar redimensiones = new Redimensionar();

    public Mensaje7(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        try {
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/CamposVacios.png");
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje7 dialog = new Mensaje7(new javax.swing.JFrame(), true);
