...
public class Mensaje3 extends javax.swing.JDialog {
        Redimensionar redimensiones = new Redimensionar();
    public Mensaje3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        try{
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/NoUsuario.png");
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje3 dialog = new Mensaje3(new javax.swing.JFrame(), true);
