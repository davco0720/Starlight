...
public class PERDER12 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PERDER12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
