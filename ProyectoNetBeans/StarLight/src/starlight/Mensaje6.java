...
public class Mensaje6 extends javax.swing.JDialog {
        Redimensionar redimensiones = new Redimensionar();
    public Mensaje6(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        ...
        try{
            redimensiones.setImageLabel(lbl_foto, "src/Mensajes/ContraseñaInsegura.png");
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mensaje6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Mensaje6 dialog = new Mensaje6(new javax.swing.JFrame(), true);
